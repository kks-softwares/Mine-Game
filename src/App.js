...
function App() {
  ...
  return (
    <div className="container">
      <div className="tower-page m-5 mb-0">
        <div className="row">
          <div className="col-12 col-sm-12 col-md-4 col-lg-4">
            <div className="tower-body">
              <div className='tower-bet-box' style={{ color: '#fff' }}>
                ...
                />
                {cashout ? (
                  <button className='play-btn mt-3' onClick={handleCashout}>CASHOUT </button>
                ) : (
                  <button className='play-btn mt-3' onClick={handlePlay} disabled={gameStarted && !gameOver}>
                ...
                <button class="custom-button mt-5 p-1">
              ...
              <div className="rowaside">
                {tilesArray.map((item) => (
                  <div className="columnaside mt-2" key={item.id}>
                    <div className={`diamond-tiles ${item.isRevealed && !item.isBomb ? 'greenDiamond' : ''}`} onClick={() => handleTileClick(item.id)}>
